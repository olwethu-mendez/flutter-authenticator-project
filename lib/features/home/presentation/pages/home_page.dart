                  ...
                  if (authState is AuthAuthenticated && authState.role == "Admin") {
                    return Column(
                      ...
                      children: [
                        ...
                        BlocBuilder<UsersBloc, UsersState>(builder: (context, usersState){
                          String userCount = "...";
                        ...
                        if (usersState is UsersLoaded) {
                          ...
                          activeUsersCount = usersState.users.where((x) => x.isDeactivated == false && x.isDeactivatedByAdmin == false && (x.emailConfirmed == true || x.phoneNumberConfirmed == true) && (x.profileId != null)).toList().length.toString();
                          deactivatedUsersCount = usersState.users.where((x) => x.isDeactivated == true && x.isDeactivatedByAdmin == false).toList().length.toString();
                          bannedUsersCount = usersState.users.where((x) => x.isDeactivatedByAdmin == true).toList().length.toString();

                          unverifiedUsersCount = usersState.users.where((x)=>x.emailConfirmed == false && x.phoneNumberConfirmed == false).toList().length.toString();
                          nonProfiledUsersCount = usersState.users.where((x)=>x.profileId == null).toList().length.toString();
                          ...
                          children: [
                            _buildWidgetCard(
                              ...
                              onPressed: () {
                                ...
                                context.push('/admin/users', extra: UsersListType.all);
                            ...
                            _buildWidgetCard(
                              ...
                              onPressed: () {                                
                                // Option A: Navigate to management page
                                context.push('/admin/users', extra: UsersListType.active);
                                // Option B: Just refresh the count
                                context.read<UsersBloc>().add(GetUsersRequested());
                              },
                              color: Colors.green,
                            ...
                            _buildWidgetCard(
                              ...
                              onPressed: () {                                
                                // Option A: Navigate to management page
                                context.push('/admin/users', extra: UsersListType.deactivated);
                                // Option B: Just refresh the count
                                context.read<UsersBloc>().add(GetUsersRequested());
                              },
                              color: Colors.red,
                            ...
                            _buildWidgetCard(
                              ...
                              onPressed: () {                                
                                // Option A: Navigate to management page
                                context.push('/admin/users', extra: UsersListType.banned);
                                // Option B: Just refresh the count
                                context.read<UsersBloc>().add(GetUsersRequested());
                              },
                              color: Colors.red,
                            ...
                            _buildWidgetCard(
                              ...
                              onPressed: () {                                
                                // Option A: Navigate to management page
                                context.push('/admin/users', extra: UsersListType.unverified);
                                // Option B: Just refresh the count
                                context.read<UsersBloc>().add(GetUsersRequested());
                              },
                            ...
                            _buildWidgetCard(
                              ...
                              onPressed: () {                                
                                // Option A: Navigate to management page
                                context.push('/admin/users', extra: UsersListType.withoutProfile);
                                // Option B: Just refresh the count
                                context.read<UsersBloc>().add(GetUsersRequested());
                              },
                              color: Colors.orangeAccent,
...
Widget _buildWidgetCard(BuildContext context, {required IconData icon, String? title, String? content, bool isGrid = false, VoidCallback? onPressed, Color? color}) {
  return Container(
        ...
        children: [
          ...
          Flexible( // Use Flexible instead of Expanded
            child: Column(
              ...
              children: [
                if (title != null)
                  Text(title, style: Theme.of(context).textTheme.titleMedium, overflow: TextOverflow.ellipsis),
                if (content != null)
                  Text(content, style: Theme.of(context).textTheme.bodySmall, overflow: TextOverflow.ellipsis),
              ],
            ),
          ),
        ],
