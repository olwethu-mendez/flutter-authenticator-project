            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  initialValue:
                      selectedGender, // Use value, not initialValue for controlled widgets
                  items:
                      [
                            "Male",
                            "Female",
                ...
                if (emailController.text.isNotEmpty &&
                  ...
                  SwitchListTile.adaptive(
                    ...
                    onChanged: (newValue) =>
                        setState(() => _prefersEmail = newValue),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final model = CreateUserModel(
                        ...
                        genderSelfDescription: isOtherGender
                            ? genderDescriptionController.text
                            : null,
                      ...
                      context.read<UsersBloc>().add(
                        CreateUserRequested(createUser: model),
                      );
                    },
